...
class GetUtkDialog(private val context: Context, private var getUtkEntity:GetUtkEntity) {
    ...
    private fun init(): GetUtkDialog {
        // 获取Dialog布局
        val view: View =
            LayoutInflater.from(context).inflate(R.layout.view_get_utk_dialog, null)
    ...
    fun setCancelable(cancel: Boolean): GetUtkDialog {
        dialog!!.setCancelable(cancel)
        return this
    }
    private var listener:RequestListener?=null
    open fun setOnRequestListener(requestListener: RequestListener):GetUtkDialog {
