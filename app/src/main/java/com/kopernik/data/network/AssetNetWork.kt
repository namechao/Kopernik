...
class AssetNetWork {
    ...
    suspend fun exchangeRecordUytTest(map: Map<String, String>) = mService.exchangeRecordUytTest(map)
    ...
    suspend fun uytTestexchange(map: Map<String, String>) = mService.uytTestexchange(map)
