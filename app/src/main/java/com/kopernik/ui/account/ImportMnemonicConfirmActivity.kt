...
import com.kopernik.ui.account.viewmodel.ImportMnemonicConfirmViewModel
import dev.utils.common.encrypt.MD5Utils
import kotlinx.android.synthetic.main.activity_import_mnemonic_confirm.*
import java.util.*

class ImportMnemonicConfirmActivity :
    ...
    override fun layoutId() = R.layout.activity_import_mnemonic_confirm
        ...
        viewModel.importAccount(
            ...
            this, androidx.lifecycle.Observer {
                if (it.status == 200) {
                    ...
                    LaunchConfig.startMainAc(this@ImportMnemonicConfirmActivity)
                    mEventBus.post(LocalEvent<Any>(LocalEvent.restartApp))
                    this@ImportMnemonicConfirmActivity.finish()
                } else {
